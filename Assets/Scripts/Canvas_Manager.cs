...
public class Canvas_Manager : MonoBehaviour
{
    ...
    public Button btn_DinoBack;
    public Button[] btn_Summon;
    ...
    public void ActivateDinoButton()
    {
        btn_DinoBack.interactable = true;
        btn_Summon[0].interactable = true;
        btn_Summon[1].interactable = true;
        btn_Summon[2].interactable = true;
    }
    public void DisableDinoButton()
    {
        btn_DinoBack.interactable = false;
        btn_Summon[0].interactable = false;
        btn_Summon[1].interactable = false;
        btn_Summon[2].interactable = false;
    }
}

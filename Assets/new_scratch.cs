...
public class new_scratch : MonoBehaviour
{
    ...
    public GameObject local_Collectiable;
    //private GameObject 
    ...
    public void PixelAlter(Vector2 pos)
    {
        ...
        */
        ...
        if(CPC_S - CPC >1100) //color pixel count decresing // remaining pixel
        {
            ScratchFinished = true;
            this.GetComponent<BoxCollider2D>().enabled = false;
            SpriteRenderer.sprite = null;
            if(local_Collectiable != null)
            {
                local_Collectiable.GetComponent<CollectiableScript>().isCollected = true;
            }
        }
    ...
    public void ResetDirt() 
    {
        ...
        CPC = CPC_S;
        if(this.gameObject.name == "Dirt_Main")
        {
            Debug.Log("main");
